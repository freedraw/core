...
DisplayNode.prototype.structureChanged = function(changes) {
  this.boundingBoxChanged()
...
DisplayNode.prototype.invalidate = function(changes) {
  var r = this.root
  if (r.isDocument) {
    r.emitThrottled('invalidate')
    if (changes) r.registerChanges(changes)
  }
}
