...
Object.defineProperty(DisplayNode.prototype, 'localToGlobal', {get: function() {
...
Object.defineProperty(DisplayNode.prototype, 'globalToLocal', {get: function() {
  return this.localToGlobal.inverse
}})

Object.defineProperty(DisplayNode.prototype, 'boundingBox', {
  get: function() {
...
DisplayNode.prototype.structureChanged = function() {
  this.boundingBoxChanged()
  this.root.emitThrottled('invalidate')
}
DisplayNode.prototype.didChange = function() {
  this.emitThrottled('change')
  this.root.emitThrottled('invalidate')
}
DisplayNode.invalidatingProperty = function(object, name) {
  var data = '_' + name
...
DisplayNode.invalidatingProperty(DisplayNode.prototype, 'transform')
DisplayNode.invalidatingProperty(DisplayNode.prototype, 'opacity')
DisplayNode.invalidatingProperty(DisplayNode.prototype, 'hidden')
DisplayNode.invalidatingProperty(DisplayNode.prototype, 'blendMode')
