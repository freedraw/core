...
invalidatingProperty(Ellipse.prototype, 'radii')
invalidatingProperty(Ellipse.prototype, 'center')
...
Ellipse.prototype.pathOn = function(cx) {
  if (cx.ellipse) {
    ...
    var c = 0.551784
    cx.moveTo(this.center.x, this.center.y + this.radii.y)
    cx.bezierCurveTo(
      this.center.x + this.radii.x * c,
      this.center.y + this.radii.y,
      this.center.x + this.radii.x,
      this.center.y + this.radii.y * c,
      this.center.x + this.radii.x,
      this.center.y)
    cx.bezierCurveTo(
      this.center.x + this.radii.x,
