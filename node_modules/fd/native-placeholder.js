...
var navigation = ['U+0008', 'Left', 'Right', 'Up', 'Down']

document.addEventListener('keydown', function(e) {
  var t = document.activeElement
  if (t && t.tagName !== 'BODY' && (!e.altKey && !e.ctrlKey && !e.metaKey || navigation.indexOf(e.keyIdentifier) !== -1)) {
    return
  }
  ...
  if (exports.hooks.runCommand(binding)) {
    e.preventDefault()
  }
})
