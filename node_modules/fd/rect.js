...
Rect.prototype.transform = function(m) {
  var corners = this.corners.map(function(p) {
...
Rect.prototype.rescale = function(a, b) {
  var wr = b.width / a.width
  var hr = b.height / a.height
  return new Rect(b.x + (this.x - a.x) * wr, b.y + (this.y - a.y) * hr, this.width * wr, this.height * hr)
}
