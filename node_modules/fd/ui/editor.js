...
function Editor() {
  ...
  commands.on('selectNext', this.selectNext, this)
  commands.on('selectPrevious', this.selectPrevious, this)
  commands.on('deselectAll', this.deselectAll, this)
...
Editor.prototype.selectNext = actOnSelection(function(s) {
  this.selection = s.next || s.parent && s.parent.first || s
})
Editor.prototype.selectPrevious = actOnSelection(function(s) {
  this.selection = s.previous || s.parent && s.parent.last || s
})
Editor.prototype.enter = actOnSelection(function(s) {
  this.selection = s.first || s
})
