...
Node.prototype.expand = function() {if (!this.open) this.toggle()}
Node.prototype.collapse = function() {if (this.open) this.toggle()}
Node.prototype.collapseAll = function(onlyChildren) {
  if (!onlyChildren) this.collapse()
