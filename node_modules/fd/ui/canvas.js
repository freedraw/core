...
function Canvas(editor) {
  ...
  var g = new M.Group().prependTo(this.document)
  for (var i = 0; i < 20; i++) {
    new M.Rectangle({
      fills: [{style: '#faa'}],
      strokes: [{style: '#000', width: 3}],
...
Object.defineProperty(Canvas.prototype, 'hoveredObject', {get: function() {
  ...
  return this.hoveredObjectIn(s && s.parent || this.document)
}})
Object.defineProperty(Canvas.prototype, 'hoveredInnerObject', {get: function() {
  return this.hoveredObjectIn(this.editor.selection || this.document)
}})
Canvas.prototype.hoveredObjectIn = function(context) {
  return context.shallowNodeAt(this.mouse.transform(this.screenToModel))
}
