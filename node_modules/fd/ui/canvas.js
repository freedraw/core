...
Object.defineProperty(Canvas.prototype, 'hoveredObject', {get: function() {
  var p = this.mouse.transform(this.screenToModel)
...
Object.defineProperty(Canvas.prototype, 'hoveredInnerObject', {get: function() {
  ...
  return parent.childAt(this.mouse.transform(this.screenToModel.concat(parent.globalToLocal))) || parent
}})
